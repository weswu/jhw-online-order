    ...
    <div class="wrap shop-wrap">
      <div class="side-bar">
        <div class="side-bar-bd" :class="{'fixed': fixed}">
          ...
          <div class="side-bar-price">RMB {{totalPrice * 0.5 * year}}</div>
      ...
      <div class="dialog_bd">
        ...
        <div class="order-price">
          <div class="order-price-item">
            ...
            <div class="order-price-item_ft">RMB {{totalPrice * 0.5 * year}}</div>
          </div>
          <div class="order-price-item">
        ...
        <div class="payment-code" v-if="payment === 'WX' && qrcode !== ''">
          <div class="payment-code-wrap" @click="toPaid">
            <img :src="'http://qr.liantu.com/api.php?w=272&text='+qrcode" alt="">
            <div class="payment-code-tip">手机微信扫码支付</div>
          </div>
        </div>
        <div class="payment-code" v-if="payment === 'ALI' && qrcode !== ''">
          <div class="payment-code-wrap" @click="toPaid">
