      ...
      groups: [
        {
          ...
          items: [
            ...
            {name: '后台小程序', html: '<img src="http://dfwjjingtai.b0.upaiyun.com/upload//a//a1//admin//picture//2018//05//08/655ebd30-5c14-4d7f-975e-faf8581eeaff.png" style="width:130px"/><br/>小程序码扫一扫<br/>管理后台后台数据'}
          ]
        }
      ]
    },
      ...
      groups: [
        {
          ...
          custom: true,
          items: [
            {name: '自选模板', price: 600, value: '297e2669600191860160021b8fcc007f', unit: '元/年', html: '详细说明： <br/>可以使用所有网站模板，包括：电脑版、手机版、微信版、商城、小程序。'},
            {name: '网站代建', price: 600, value: '297e26696052b23201605425f360016a', unit: '元/年', html: '详细说明： <br/>您需要指定一个模板，并提供给我们全部的资料和图片，由我们负责录入和设定'},
            {name: '定制设计', price: 600, value: '297e2669600191860160021c49970083', unit: '元/年', html: '详细说明： <br/>由经验丰富的专业设计师来定制网站相关内容。价格=基础价格X设计师经验值'}
          ],
          cardId: '',
          card: [
      ...
      groups: [
        {
          ...
          value: [],
          items: [
            {name: '小程序', price: 1500, value: '297e2669600191860160021f845900a7', unit: '元/年', html: '功能说明：<br/>小程序是一种不需要下载安装即可使用的应用<br/>小程序内容支持与网站数据同步<br/>小程序支持自主设计页面<br/>小程序分为展示型、商城型（<span style="color:#ff5500">5800—8800元</span>）'},
      ...
      row.items.map(item => {
        if (item.value === row.value) {
          ...
          if (item.unit === '元/首年') {
            ...
            if (item.renew) row.price = item.renew * state.year
          }
        }
      })
